...
class Exercise extends \yii\db\ActiveRecord
{
    ...
    public function DayExercises()
    {
        ...
        $dataProvider = new SqlDataProvider([
            'sql' => "SELECT exercises.id AS exercises_id, activity_category.image, activity_category.name AS category_name, min, burned_cal, daily_goal, exercises.created_at
                    FROM exercises
